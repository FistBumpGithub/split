...
static const int LAST_POW_BLOCK = 999999;   //last pow reward @ Block 52560 otherwise Zero Reward
...
static const int64_t MIN_TX_FEE = 2017;  //lowered TX fee acording to low Block Rewards
